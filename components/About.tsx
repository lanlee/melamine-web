        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-slate-500 text-base leading-loose mb-4">
              {lang === "en"
                ? "Guangdong HC Material Co., Ltd (广东翰成物资有限公司) is headquartered in Guangzhou, Guangdong — the heart of South China's chemical manufacturing belt. We are the region's largest melamine wholesaler, distributing over 3,000 metric tons each month to customers across Asia, Europe, the Americas, the Middle East, and Africa."
